                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <!--end::Export-->
                                            <!--begin::Add customer-->
                                            <a href="{{route('admin.customers.create')}}" class="btn btn-primary">Add
                                                Customer</a>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        @forelse($customers as $key => $customer)
                                            <tr>
                                                <td>
                                                    <a href=""
                                                       class="text-gray-800 text-hover-primary mb-1">{{ucwords($customer->full_name)}}</a>
                                                </td>
                                                <!--end::Name=-->
                                                <!--begin::Email=-->
                                                <td>
                                                ...
                                                <td class="">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{route('admin.customers.show',['id'=>$customer->id])}}"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <button type="button"
                                                                    ...
                                                                    data-dismiss="modal"
                                                                    onclick="deleteModal(this,'{{$customer->id}}')">
                                                                Delete
                                                            </button>
                                                        </div>
                                                        <!--end::Menu item-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form id="customersExport" class="form"
                                                  action="{{route('admin.customers.export')}}" method="POST">
                                            @csrf
                                            <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <select data-control="select2" data-placeholder="Select a format"
                                                            data-hide-search="true" name="ext"
...
@push('scripts')
    ...
    <script>
        ...
        function deleteModal(input, id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete(`/admin/customers/${id}`).then(function (response) {
                        Swal.fire({
        ...
        var myModal = new bootstrap.Modal(document.getElementById('kt_customers_export_modal'), {
            keyboard: false
        });
