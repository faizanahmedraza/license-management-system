                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div id="kt_account_profile_details" class="collapse show">
                                ...
                                <form id="kt_customer_form" class="form" method="POST"
                                      action="{{route('admin.licenses.update',['id'=>$license->id])}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="text" name="license_code"
                                                               ...
                                                               value="{{ old('license_code',$license->license_code) }}"/>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Row-->
                                        ...
                                        <div class="row mb-6 expiry">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input class="form-control form-control-solid"
                                                       ...
                                                       value="{{old('expiry',$license->expiry)}}"/>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(e).flatpickr({
            ...
            altFormat: "F j, Y",
            dateFormat: "Y-m-d",
            defaultDate: "{{old('expiry',$license->expiry)}}"
        })
    </script>
@endpush
