                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-here-bg me-0 me-lg-2">
                        ...
                        <span class="menu-link">
											<span class="menu-title">{{ __('Dashboard') }}s</span>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ ucwords(auth()->user()->full_name) }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ auth()->user()->user_role }}</span>
                                    </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('admin.settings.index')}}" class="menu-link px-5">My Account</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <form method="POST" action="{{route('admin.logout')}}">
                                @csrf
                                <button class="bg-transparent border-0 fw-bold menu-link px-5">Sign Out</button>
                            </form>
                        </div>
                        <!--end::Menu item-->
                    </div>
