...
var KTMenu = function (e, t) {
    ...
    if (null != e) {
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
            ...
            return function (e) {
                var t = T(e), i = K(t), r = e.closest(".tab-pane"),
...
var KTSticky = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            var t, i = u("offset"), r = u("reverse");
            if (!1 !== i) if (i = parseInt(i), t = KTUtil.getScrollTop(), document.documentElement.scrollHeight - window.innerHeight - KTUtil.getScrollTop(), !0 === r) {
                if (t > i) {
...
var KTUtil = function () {
    ...
    return {
        init: function (e) {
            ...
            const n = e.offsetTop, i = n + e.clientHeight, r = t.scrollTop, o = r + t.clientHeight;
...
var KTThemeMode = function () {
    var e, t, n = this, i = function (e) {
        ...
        var t = i("menu"), n = e ? e.querySelector('.active[data-kt-element="mode"]') : null;
        ...
        var n = i("menu"), r = t.getAttribute("data-kt-value"), o = e.querySelector('.active[data-kt-element="mode"]');
        ...
        init: function () {
            e = document.querySelector('[data-kt-element="theme-mode-menu"]'), t = document.documentElement, o(r(), a()), KTEventHandler.trigger(t, "kt.thememode.init", n), e && (i("menu"), [].slice.call(e.querySelectorAll('[data-kt-element="mode"]')).map((function (e) {
                e.addEventListener("click", (function (i) {
                    i.preventDefault();
                    var r = e.getAttribute("data-kt-value"), a = r;
