...
var KTProductsExport = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_licenses_export_modal"), a = new bootstrap.Modal(t), i = document.querySelector("#kt_licenses_export_form"), e = i.querySelector("#kt_licenses_export_submit"), n = i.querySelector("#kt_licenses_export_cancel"), o = t.querySelector("#kt_licenses_export_close"), r = FormValidation.formValidation(i, {
