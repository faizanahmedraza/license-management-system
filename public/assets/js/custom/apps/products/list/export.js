...
var KTProductsExport = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_products_export_modal"), a = new bootstrap.Modal(t), i = document.querySelector("#kt_products_export_form"), e = i.querySelector("#kt_products_export_submit"), n = i.querySelector("#kt_products_export_cancel"), o = t.querySelector("#kt_products_export_close"), r = FormValidation.formValidation(i, {
                ...
                t.preventDefault(), r && r.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout((function () {
                        e.removeAttribute("data-kt-indicator"), Swal.fire({
                            text: "Product list has been successfully exported!",
                            icon: "success",
                            buttonsStyling: !1,
                ...
                $(t).flatpickr({altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d", locale: "sl", mode: "range"})
            }()
        }
    }
}();
