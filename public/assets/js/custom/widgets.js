...
var KTWidgets = {
    init: function () {
        ...
        !function () {
            ...
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--kt-gray-800"),
                    r = KTUtil.getCssVariableValue("--kt-" + a), s = KTUtil.getCssVariableValue("--kt-" + a + "-light");
                new ApexCharts(e, {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    var a = parseInt(KTUtil.css(e, "height")), o = KTUtil.getCssVariableValue("--kt-gray-500"),
                        r = KTUtil.getCssVariableValue("--kt-gray-200"), s = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    ...
                    var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                        o = KTUtil.getCssVariableValue("--kt-gray-200"), r = KTUtil.getCssVariableValue("--kt-info"),
                        s = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                        o = KTUtil.getCssVariableValue("--kt-gray-200"), r = KTUtil.getCssVariableValue("--kt-success"),
                        s = KTUtil.getCssVariableValue("--kt-success-light"),
                        l = KTUtil.getCssVariableValue("--kt-warning"),
                        i = KTUtil.getCssVariableValue("--kt-warning-light"), n = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                        o = KTUtil.getCssVariableValue("--kt-gray-200"), r = {
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    parseInt(KTUtil.css(e, "height"));
                    var a = KTUtil.getCssVariableValue("--kt-gray-500"),
                        o = KTUtil.getCssVariableValue("--kt-gray-200"), r = KTUtil.getCssVariableValue("--kt-primary"),
                        s = KTUtil.getCssVariableValue("--kt-primary-light"), l = {
                            series: [{
                                name: "Net Profit",
                                type: "bar",
                                stacked: !0,
            ...
            if (e) {
                var t = {self: null, rendered: !1}, a = function () {
                    var a = parseInt(KTUtil.css(e, "height")), o = KTUtil.getCssVariableValue("--kt-gray-500"),
                        ...
                        s = KTUtil.getCssVariableValue("--kt-gray-300"), l = KTUtil.getCssVariableValue("--kt-warning"),
                        ...
                        c = KTUtil.getCssVariableValue("--kt-primary"), h = {
            ...
            var e, t, a, o = document.querySelectorAll(".mixed-widget-2-chart"),
                r = KTUtil.getCssVariableValue("--kt-gray-500"), s = KTUtil.getCssVariableValue("--kt-gray-200");
            ...
            [].slice.call(e).map((function (e) {
                ...
                if (e) {
                    var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--kt-gray-800"),
                        r = KTUtil.getCssVariableValue("--kt-gray-300"), s = KTUtil.getCssVariableValue("--kt-" + a),
            ...
            [].slice.call(e).map((function (e) {
                var t = parseInt(KTUtil.css(e, "height"));
                if (e) {
                    var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--kt-" + a),
            ...
            var e, t = document.querySelectorAll(".mixed-widget-12-chart"),
                a = KTUtil.getCssVariableValue("--kt-gray-500"), o = KTUtil.getCssVariableValue("--kt-gray-200");
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--kt-gray-800"), o = KTUtil.getCssVariableValue("--kt-gray-800"),
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--kt-gray-800"), o = KTUtil.getCssVariableValue("--kt-info"),
